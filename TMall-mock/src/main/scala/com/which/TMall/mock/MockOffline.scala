package com.which.TMall.mock
import java.text.SimpleDateFormat
import java.util.UUID

import com.which.TMall.common.bean.{CityInfo, ProductInfo, UserInfo, UserVisitAction}
import com.which.TMall.common.util.ConfigurationUtil
import com.which.TMall.mock.util.{RandomDate, RandomNumUtil, RandomOptions}
...
object MockOffline {
  ...
  val professionOpts = RandomOptions(("学生",4),("程序员",3),("经理",2),("老师",1)) //职业

   val genderOpts = RandomOptions(("男",6),("女",4)) //性别
  /*用户相关参数，设置完毕*/
  ...
  def main(args: Array[String]): Unit = {
    ...
    val spark: SparkSession = SparkSession
      ...
      .appName("MockOffline")
      .enableHiveSupport()
      .config("spark.sql.warehouse.dir", "hdfs://hadoopMaster-201:9000/user/hive/warehouse")
      .getOrCreate()
