...
import com.which.TMall.common.bean.CityInfo
import com.which.TMall.mock.util.{RandomNumUtil, RandomOptions}
...
object MockRealTime {
  ...
  def createKafkaProducer: KafkaProducer[String, String] = {
    ...
    // Kafka服务端的主机名和端口号
    props.put("bootstrap.servers", "hadoopMaster-201:9092,hadoopSlaver-202:9092,hadoopSlaver-203:9092")
    // 等待所有副本节点的应答
    props.put("acks", "1")
    // 重试最大次数
    props.put("retries", "0")
